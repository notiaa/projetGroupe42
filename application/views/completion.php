...
<body>
    ...
    <div class="radio-tile-group">
        <div class="input-container">
          <input id="walk" type="radio" name="transport" value="fille">
        ...
        <div class="input-container">
          <input id="bike" type="radio" name="transport" value="garçon">
          <div class="radio-tile">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-6">
            <input type="number" class="form-control" name="poids" value="" /><span>x Kg</span>
        </div>
    </div>
    <div class="row mb-3">
        <label class="col-sm-3 col-form-label">Taille</label>
        <div class="col-sm-6">
            <input type="number" class="form-control" name="taille" value="" /><span>x Cm</span>
        </div>
    </div>
    <div class="row mb-3">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-6">
            <input type="number" class="form-control" name="nbkilo" value="" />
        </div>
    </div>
